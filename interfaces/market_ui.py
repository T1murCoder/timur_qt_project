...
class Ui_Market(object):
    def setupUi(self, Market):
        ...
        Market.resize(800, 600)
        Market.setMinimumSize(QtCore.QSize(800, 600))
        Market.setMaximumSize(QtCore.QSize(800, 600))
        ...
        self.lbl_order = QtWidgets.QLabel(self.tab_basket)
        self.lbl_order.setGeometry(QtCore.QRect(210, 440, 521, 16))
    ...
    def retranslateUi(self, Market):
        ...
        Market.setWindowTitle(_translate("Market", "Market"))
        self.btn_search.setText(_translate("Market", "Поиск"))
        self.label.setText(_translate("Market", "Категории:"))
        self.btn_add_to_basket.setText(_translate("Market", "Добавить в корзину"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_market), _translate("Market", "Магазин"))
        self.label_2.setText(_translate("Market", "Корзина:"))
        self.btn_order.setText(_translate("Market", "Оформить"))
        self.btn_delete.setText(_translate("Market", "Удалить"))
        self.btn_reset.setText(_translate("Market", "Сбросить"))
        self.label_3.setText(_translate("Market", "Итого:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_basket), _translate("Market", "Корзина"))
        self.label_4.setText(_translate("Market", "Имя:"))
        self.label_5.setText(_translate("Market", "Банковская карта:"))
        self.btn_link_card.setText(_translate("Market", "Привязать"))
        self.label_6.setText(_translate("Market", "Номер телефона:"))
        self.btn_link_phone.setText(_translate("Market", "Привязать"))
        self.btn_delete_card.setText(_translate("Market", "Удалить"))
        self.btn_delete_phone.setText(_translate("Market", "Удалить"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_profile), _translate("Market", "Профиль"))
